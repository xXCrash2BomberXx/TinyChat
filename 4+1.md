...
```mermaid
stateDiagram
  Client1 --> Initialization
  classDef custom fill:#fff,color:#000;
  class Client1 custom
  ...
  state Communication {
    ...
    ReceivedMessage --> UnsendMessage: Received Unsend Request (Empty Edit)
